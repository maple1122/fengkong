 ...
 * @date 2025/5/6 14:15
 */
public class ApiDetection2Test {

    private static String baseUrl = "http://monitor.pdmiryun.com";

    @BeforeClass
    public void setup() {
        RestAssured.baseURI = "http://monitor.pdmiryun.com";
    }

    @Test
    public void testApiDection() {
        ...
        Response response = RestAssured.given()
                ...
                .headers(headerMap)
                .when()
                .get("/monitor/api/token/accessToken");
...
//        String s = HttpClient4Util.doPostJson(formatUrl, paramMap, headerMap);
        ...
        //断言
        Assert.assertTrue(Integer.valueOf(response.path("status").toString())==200);
    }
